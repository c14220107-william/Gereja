...
<head>
 ...
 <style>
            ...
            .main-banner {
                display: flex;
                justify-content: center; /* Untuk meletakkan konten di tengah secara horizontal */
                align-items: center; /* Untuk meletakkan konten di tengah secara vertikal */
                height: 100vh; /* Memberikan tinggi 100% dari viewport */
            }
            iframe {
                width: 800px; /* Lebar video */
                height: 450px; /* Tinggi video */
        ...
        .small-video {
            width: 97%; /* Lebar video kecil */
            height: 60%;
            margin: 10px 10px 10px; Jarak antar video kecil
            border: none;
            border-radius: 8px;
        ...
        .cs {
            ...
            border-radius: 15px;
            width: 90%; /* Ubah lebar menjadi 90% untuk responsivitas */
            max-width: 800px; /* Maksimum lebar 800px */
        ...
        .cs h1 {
            font-size: 36px; /* Ukuran font yang disesuaikan */
            font-weight: bold;
            margin: 0;
        }
        .cs p {
...
<body>
 ...
 <div class="main-banner">
  <iframe height="400" src="https://www.youtube.com/embed/6stlCkUDG_s?si=wM4-VVX4O_ucSuZL" width="600">
  </iframe>
 </div>
