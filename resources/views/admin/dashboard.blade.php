...
<div class="container mx-auto my-10 px-6">
    ...
    <!-- All Members Card -->
    <div data-aos="fade-up" class="bg-gradient-to-r from-gray-500 via-gray-600 to-gray-700 text-white rounded-lg p-6 shadow-lg hover:scale-105 hover:shadow-xl transition-all transform">
    ...
    <!-- New Members Card -->
    <div data-aos="fade-up" class="bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 text-white rounded-lg p-6 shadow-lg hover:scale-105 hover:shadow-xl transition-all transform">
        <div class="flex items-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2 text-white" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a href="{{ route('manajemenJemaat.index2')}}" class="mt-4 inline-block text-gray-200 hover:text-gray-300">View Details</a>
    </div>

    <!-- Givings Card -->
    <div data-aos="fade-up" class="bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 text-white rounded-lg p-6 shadow-lg hover:scale-105 hover:shadow-xl transition-all transform">
        <div class="flex items-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2 text-white" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm2-8a2 2 0 11-4 0 2 2 0 014 0z" clip-rule="evenodd" />
            </svg>
        ...
        <a href="{{ route('manajemenJemaat.index3')}}" class="mt-4 inline-block text-gray-200 hover:text-gray-300">View Details</a>
    </div>

    <!-- Birthdays Card -->
    <div data-aos="fade-up" class="bg-gradient-to-r from-gray-600 via-gray-400 to-gray-400 text-white rounded-lg p-6 shadow-lg hover:scale-105 hover:shadow-xl transition-all transform">
        <div class="flex items-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2 text-white" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a href="{{route ('manajemen_faq.index')}}" class="mt-4 inline-block text-gray-200 hover:text-gray-300">View Details</a>
    </div>
