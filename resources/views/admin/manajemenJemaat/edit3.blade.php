...
@section('content')
<h1 class="text-2xl font-bold mb-6">Edit Baptism Request</h1>
<form action="{{ route('form3.update', $formBaptisan->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
    @csrf
    @method('PUT')
