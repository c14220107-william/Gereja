...
<form action="{{ route('Form.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <div>
        ...
        <input type="text" id="tanggal_lahir_calon_mempelai_wanita" name="tanggal_lahir_calon_mempelai_wanita" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>
    ...
    <div>
        ...
        <input type="text" id="nama_anak" name="nama_anak" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="nomor_telp" class="block font-medium text-gray-700">Nomor Telepon:</label>
        <input type="text" id="nomor_telp" name="nomor_telp" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="tempat_lahir" class="block font-medium text-gray-700">Tempat Lahir:</label>
        <input type="text" id="tempat_lahir" name="tempat_lahir" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>
    ...
    <div>
        ...
        <input type="text" id="alamat" name="alamat" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="kelurahan" class="block font-medium text-gray-700">Kelurahan:</label>
        <input type="text" id="kelurahan" name="kelurahan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="beribadah_di" class="block font-medium text-gray-700">Beribadah di:</label>
        <input type="text" id="beribadah_di" name="beribadah_di" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="nama_ayah" class="block font-medium text-gray-700">Nama Ayah:</label>
        <input type="text" id="nama_ayah" name="nama_ayah" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>

    <div>
        <label for="nama_ibu" class="block font-medium text-gray-700">Nama Ibu:</label>
        <input type="text" id="nama_ibu" name="nama_ibu" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>
    ...
    <div>
        ...
        <input type="text" id="pembaptis" name="pembaptis" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
    </div>
