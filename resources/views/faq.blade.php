...
<section class="relative bg-black">
    ...
    <section id="faq" class="py-20 bg-gray-100">
        <div class="container mx-auto text-center fade-in">
            <h2 class="text-4xl font-bold mb-8 text-white">Pertanyaan yang Sering Diajukan (FAQ)</h2>
    ...
    <section id="contact-form" class="py-4 fade-in -mt-12">
        <div class="container mx-auto text-center mb-4">
            <h2 class="text-4xl font-bold mb-2 text-white">Ajukan Kritik dan Saran</h2>
            <p class="mb-4 text-white">Silakan isi formulir di bawah ini untuk mengajukan kritik dan saran kepada kami.</p>
